...
class RoomByMemberRepositoryImplTest {
    ...
    fun `updateRoomByMember should update all provided fields`() {
        ...
        StepVerifier.create(updatedRecord)
            .assertNext {
                assertThat(it.lastMessagePreview).isEqualTo("See you soon!")
                assertThat(it.lastMessenger).isEqualTo("John Doe")
                assertThat(it.avatarExtension).isEqualTo("jpg")
            }
            .verifyComplete()
    }
    ...
    fun `updateRoomByMember should update only specified fields`() {
        ...
        StepVerifier.create(updatedRecord)
            .assertNext {
                assertThat(it.lastMessagePreview).isEqualTo("Just this one")
                assertThat(it.lastMessenger).isNull()
                assertThat(it.avatarExtension).isNull()
            }
            .verifyComplete()
    }
